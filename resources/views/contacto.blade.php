                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="checker" id="uniform-customer_privacy">
                                      <input type="checkbox" value="0" required  name="terms" autocomplete="off"> 
                                        <a class="f-18" style="color: #666666;" href="{{ route('companies.policies') }}"><b> He leído y acepto la política de privacidad</b></a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
