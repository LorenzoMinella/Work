...
@section('main-content')
	...
	{!! Form::open(array('route' => 'faqs_categories.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
    {{ csrf_field() }}
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="category_name">Nombre Categoría:</label>
		            {!! Form::text('category_name', null, array('placeholder' => 'Nombre Categoría: ','class' => 'form-control')) !!}
                </div>
                <div class="form-group">
