              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="title">Título del Post:</label>
		            {!! Form::text('title', null, array('placeholder' => 'Título del Post: ','class' => 'form-control')) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="content">Contenido Post:</label>
		            {!! Form::textarea('content', null, array('placeholder' => 'Contenido Post: ','class' => 'form-control')) !!}
                </div>
              </div>
              <!-- /.box-body -->
