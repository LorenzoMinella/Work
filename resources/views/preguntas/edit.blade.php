        ...
        <div class="col-md-3 col-md-offset-1">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                              ...
                              $attributes = ['class'=>'btn btn-danger btn-block']);!!}  
                    <a class="btn btn-warning btn-block" href="#">Ver Camino Generado</a>
               ...
               <div class="box box-primary">
                  ...
                  <form role="form">
                    <div class="box-body">
                      ...
                      @if( ($form->have_first_question == 1) && ($question->first_question == 1) )
                      <div class="form-group">
                        <label for="last_question">¿Es la primera pregunta?</label>
                                {!! Form::checkbox('last_question', $question->last_question); !!}
                      </div>
                      @endif
                      @if( ($form->have_last_question == 1) && ($question->last_question == 1) )
                      <div class="form-group">
                        <label for="last_question">¿ Es la última pregunta ?</label>
                                {!! Form::checkbox('last_question', $question->last_question); !!}
                      </div>
                      @endif
                    </div>
