							...
							<div class="col-md-7">
				                <div class="form-group">
				                  <label for="content">Preguntas:</label>
				                    {!! Form::select('next_question',$questions,[], array('class' => 'form-control preguntas', 'id' => 'preguntas', 'title' => 'Seleccionar', 'placeholder' => 'Seleccionar', 'required' => 'required' )) !!}
				                </div>
				            </div>
			              </div>
			              <div class="box-body">
							<div class="col-md-12">
				                <div id="respuesta" class="form-group respuesta hidden">
